...
```
The data contains both categorial and scale variables. To perform the regression model we need to convert these categorical into scale variables. So, I have performed this conversion of data.
